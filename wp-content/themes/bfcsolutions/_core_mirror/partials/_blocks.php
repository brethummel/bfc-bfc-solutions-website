	...
	if (have_rows('content_blocks', $id)):
		while (have_rows('content_blocks', $id)) : the_row();
			...
			if ($displayblock) {
				...
				if ($layout == 'block_equipment'):
					get_template_part('partials/custom/block_equipment/block_equipment', null, $block);
				elseif ($layout == 'block_findservice'):
					get_template_part('partials/custom/block_findservice/block_findservice', null, $block);
				elseif ($layout == 'block_hero'):
					get_template_part('partials/custom/block_hero/block_hero', null, $block);
				elseif ($layout == 'block_servicecards'):
					get_template_part('partials/custom/block_servicecards/block_servicecards', null, $block);
				elseif ($layout == 'block_timeline'):
					get_template_part('partials/custom/block_timeline/block_timeline', null, $block);
				elseif ($layout == 'block_whoweserve'):
					get_template_part('partials/custom/block_whoweserve/block_whoweserve', null, $block);
				endif;
