			...
			<div class="container">
				<div class="row">
					<div class="col-12 notice" data-nosnippet>
						...
						?>
						<?php echo(get_field('sitebanner_text', 'options')); ?>&nbsp;&nbsp;<a class="more" <?php if(isset($target)) { ?>target=<?php echo($target); ?> <?php } ?>href="<?php echo($dest); ?>"><?php echo(get_field('sitebanner_settings', 'options')['text']); ?></a>
					</div>
				</div>
			</div>
		</div>
