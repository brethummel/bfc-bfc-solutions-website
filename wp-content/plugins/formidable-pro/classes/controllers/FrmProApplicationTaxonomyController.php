...
class FrmProApplicationTaxonomyController {
	...
	/**
	 * @var FrmProApplicationRelationHelper
	 */
	...
	private static function get_new_item_redirect( $type, $term_id ) {
		switch ( $type ) {
			case 'form':
				$page = class_exists( 'FrmFormTemplatesController' ) ? FrmFormTemplatesController::PAGE_SLUG : 'formidable&triggerNewFormModal=1';
				return admin_url( 'admin.php?page=' . $page . '&applicationId=' . $term_id );
			case 'view':
